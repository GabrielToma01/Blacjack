...
public class GameF extends AppCompatActivity {
    public int x = 0;
    @Override
    ...
    public void Draw(View v)
    {
        ...
        ((ImageView)findViewById(R.id.imageView3)).setImageResource(images[i]);
        ...
        x = x + i;
         if(x > 21) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(GameF.this).create();
    ...
    public void Stop(View v) {
        Intent intent = new Intent(getApplicationContext(), GameP2.class);
        intent.putExtra("PlayerScore", x);
